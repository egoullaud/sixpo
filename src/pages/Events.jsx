...
import festivalPhoto from '../assets/SIXPO-Landing-Page-Banner-scaled.webp'
      ...
      <section className='flex flex-col bg-white'>
        <div className=' flex justify-evenly'>
          <div className='flex flex-col lg:w-[40%] md:w-[40%]'>
            <h2 className='font-bold text-2xl m-[2rem]'>Event Details</h2>
            <p className='mx-[2rem]'> <span className='font-bold'>Virtual:</span> April 1 - 19, 2023 <br/>
             <span className='font-bold'>In-person:</span> April 20 - 22, 2023 <br/>
             <span className='font-bold'>Cost:</span> By Donation<br/>
              </p>
            <p className='m-[2rem]'> 
             ...
             <h2 className='font-bold text-2xl mx-[2rem]'>Location</h2>
             <p className='m-[2rem]'>
                Heritage Hall <br/>
                3102 Main Street, <br/>
          ...
          <div className='flex items-center justify-evenly lg:w-[50%] md:w-[60%]'>
            <img className='m-[3rem] lg:w-[90%] rounded-md' src={festivalPhoto} alt="" />
          </div>
        </div>
      </section>
