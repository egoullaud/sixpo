  ...
  return (
    <div>
      ...
      <section>
        ...
        <div>
          <h1
            className="font-bold text-2xl mx-[2rem] mb-[2rem] text-center
          lg:text-4xl"
          >
            Our Speakers
          </h1>
      ...
      <section
        className="flex flex-col justify-evenly items-start bg-black  text-white  border-b-2 border-b-[#ff7070] py-[2rem] w-[100%]
      md:py-[3rem]
      lg:flex-row"
      >
        <div
          className="flex flex-col justify-center items-center my-[3rem] mx-auto
                 md:w-[80%]
                 lg:w-[60%] "
        >
          <h1
