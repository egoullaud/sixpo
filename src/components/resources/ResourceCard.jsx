        ...
        {resources.map((resource) =>(
                <div className='bg-white my-2 rounded shadow-lg flex flex-col items-center justify-evenly
                    ...
                    <div className='flex flex-col items-center text-center  mb-4 w-[90%]
                                  md:text-left md:mr-4 md:w-[60%]
                                  '>
                      <h3 className=' font-bold mx-4 mt-2 text-2xl
                                lg:mt-6 
                                ' >{resource.title}</h3>
                     <a href={resource.url} target="_blank" className=''> <h4 className=' text-blue-600  font-semibold mx-4 mt-2 
                                md:text-lg
                                '> Visit Website</h4></a>
                      <p className='text-base mx-4 my-2 text-center' dangerouslySetInnerHTML={{__html:resource.content.html}}  ></p>
                    </div>
