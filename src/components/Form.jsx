    ...
    <div>
      <div>
        ...
        >
          ...
          <div>
            <label for="text" class="block mb-2 text-sm font-medium text-white">
              Your Phone Number
            </label>
            <input
              type="text"
          ...
          <label for="where" class="block mb-2 text-sm font-medium text-white">
          ...
          <div class="flex flex-col ">
            <label
              class="flex  items-start mb-2 text-sm font-medium text-white"
              name="interested-in"
            >
              I'm interested in:
            </label>
            <div className="flex items-center justify-center text-white">
              <input
                ...
                value="yes"
              />
              <label htmlFor="volunteering" class="mx-2 text-sm">
                Volunteering
              </label>
            </div>
            <div className="flex items-center justify-center text-white">
              <input
                ...
                value="yes"
              />
              <label htmlFor="sponsoring" class="ml-2 mr-5 my-1 text-sm">
                Sponsoring
              </label>
            </div>
            <div className="flex items-center justify-center text-white">
              <input
                ...
                value="yes"
              />
              <label htmlFor="collaborating" class="mx-2 text-sm">
                Collaborating
              </label>
            </div>
          </div>
          ...
          hover:bg-[#ff7070] hover:ease-in-out hover:duration-500
           bg-black w-[200px] border-2 border-[#F86E6E] 
           font-medium my-6 mx-auto py-3 text-white
           "
          >
            Send message
          </button>
